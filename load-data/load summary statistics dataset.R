...
group_s <- c("Avdeenko et al. (2019)", "Anderson and McKenzie (2020)",
...
Sales_expanded <- data.frame(group_s, tau_s, se_s, Female_proportion_s, Urban_proportion_s, GDP_pc_growth_s)

# Export
write.table(Sales, file = "/Users/sunny/Library/CloudStorage/OneDrive-Personal/Documents/MPhil/Thesis/Thesis/R/Sales summary stats.csv", sep=",", row.names=FALSE)
write.table(Sales_expanded, file = "/Users/sunny/Library/CloudStorage/OneDrive-Personal/Documents/MPhil/Thesis/Thesis/R/Sales stats with covariates.csv", sep=",", row.names=FALSE)

# Next create Profits df with effect sizes (tau) and std errors
group_p <- c("Avdeenko et al. (2019)", "Anderson and McKenzie (2020)", "Buvinic et al. (2020)",
           "Alibhai et al. (2019)", "Brooks et al. (2018)", "Campos et al. (2017)",
...
Profits_expanded <- data.frame(group_p, tau_p, se_p, Female_proportion_p, Urban_proportion_p, GDP_pc_growth_p)

# Export
write.table(Profits, file = "/Users/sunny/Library/CloudStorage/OneDrive-Personal/Documents/MPhil/Thesis/Thesis/R/Profits summary stats.csv", sep=",", row.names=FALSE)
write.table(Profits_expanded, file = "/Users/sunny/Library/CloudStorage/OneDrive-Personal/Documents/MPhil/Thesis/Thesis/R/Profits stats with covariates.csv", sep=",", row.names=FALSE)
